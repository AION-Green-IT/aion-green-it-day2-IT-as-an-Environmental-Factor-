...
type Props = {
  open: boolean;
  title: string;
  /** What the action will do, in the user's terms. */
...
/**
 * R5: dismissable by Esc, backdrop click and a visible button. Focus moves to
 * the safe choice on open and returns where it came from on close.
 */
