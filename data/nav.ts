...
export const NAV_ITEMS: NavItem[] = [
  ...
  { href: "/case/dataform", label: "Case A — DataForm", short: "DataForm", icon: "case" },
  { href: "/case/netcore", label: "Case B — NetCore", short: "NetCore", icon: "case" },
  { href: "/case/artemis", label: "Case C — Artemis", short: "Artemis", icon: "case" },
